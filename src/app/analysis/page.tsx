...
const analysisPhases = [
  {
    ...
    description: "Convert code into tokens using a lexer.",
    route: "/analysis/lexical",
  },
  {
    title: "Syntax Analysis",
    description: "Build a syntax tree with parser logic.",
    route: "/analysis/syntax",
  },
  {
    title: "Semantic Analysis",
    description: "Validate type rules and meaning.",
    route: "/analysis/semantic",
  },
];
      ...
      <div className="max-w-6xl mx-auto px-4 py-16">
        <motion.div
          ...
          <p className="text-lg text-gray-400">
            Choose a phase to explore how compilers break down, structure, and
            analyze code.
          </p>
        </motion.div>
